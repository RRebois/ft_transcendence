...
class	GameManagerView(APIView):
	...
	def	verify_data(self, game_name, game_code, session_id):
		...
		# 21 => local vs a friend (password needed)
		# 22 => remote 1 vs 1
		# 23 => remote 1 vs 1 (tournament mode)
		# 40 => remote 2 vs 2
		if game_code not in [10, 20, 21, 22, 23, 40]:
